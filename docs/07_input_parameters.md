...
| mosdepth_spectre_bin_size | integer | Bin size in bp for mosdepth windowing and Spectre CNV calling. | Larger sizes reduce noise, however this may result in reduced sensitivity. | 1000 |
