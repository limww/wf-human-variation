...
### Added
- bigWig tracks for visualisation of 5mC counts are output when using the modification subworkflow.
- Workflow overview diagram in the documentation.
### Removed
- When running with `--mod --phased`, `{{ alias }}.wf_mods.ungrouped.bedmethyl.gz` is no longer generated by modkit.
